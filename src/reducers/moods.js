	...
	switch (action.type) {
		case 'SET_MS_TO_LEVEL_1':
			return {...state, money_status_is_set: true, current_$_status: action.current_$_status, 
				product_query: {...state.product_query, 'order': 'price_per_liter_of_alcohol_in_cents.asc', 'where_not': 'is_dead,is_discontinued'} 
			} ;
		case 'SET_MS_TO_LEVEL_2':
			return {...state, money_status_is_set: true, current_$_status: action.current_$_status, 
				product_query: {...state.product_query, 'order': 'price_in_cents.asc'} 
			};
		case 'SET_MS_TO_LEVEL_3':
			return {...state, money_status_is_set: true, current_$_status: action.current_$_status, 
				product_query: {...state.product_query, 'order': 'price_in_cents.desc', 'where_not': 'is_dead,is_discontinued'} 
			};
